...
class TurtleBotController:
    ...
    def move_to_waypoint(self, waypoint):
        ...
        # 각 웨이포인트의 좌표 설정
        waypoints = {
            1: (5.6462, 3.16, 0.32863,0.94446),
            2: (5.9635,3.0937,-0.416454,0.90912),
            3: (6.1686, 2.8176, -0.39068, 0.92053),
            4: (5.9635,3.0937,-0.416454,0.90912),
            5: (5.6462, 3.16, 0.32863,0.94446),
            6: (5.1812, 2.8361, 0.32103, 0.94707)
        }
